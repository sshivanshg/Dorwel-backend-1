# Dorwel - Interior Design Management Tool Backend API

A comprehensive backend API for Dorwel, an interior design management tool built with Node.js, Express, and Mongoose. This system provides robust user management, role-based access control, and essential features for interior design businesses.
...
```bash
git clone <your-dorwel-repo-url>
cd dorwel-backend
```
